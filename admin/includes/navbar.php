<header class="main-header" style="background-color:#717A83 " >
  ...
  <a href="#" class="logo " style="background-color: #717A83">
    ...
    <span class="logo-lg " style="background-color:#717A83 ;color:white ; font-size: 22px; font-family:Times  "><marquee behavior="scroll" direction="left">Finger-print Voting System</marquee></span>
